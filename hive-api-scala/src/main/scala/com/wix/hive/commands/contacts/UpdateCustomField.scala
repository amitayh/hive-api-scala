...
case class UpdateCustomField(contactId: String, customFieldId: String, customField: ContactCustomFieldDTO, modifiedAt: DateTime) extends UpdateContactCommand[Contact] {
