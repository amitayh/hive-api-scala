...
class NotificationCreationData(title: String, content: String, @JsonScalaEnumeration(classOf[NotificationTypeRef])`type`: NotificationType
                               , clickToAction: Option[ClickToAction] = None, expiration: Option[DateTime] = None)
